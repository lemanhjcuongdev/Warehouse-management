...
warehouseRouter.get('/id/:id', [checkJwt], warehouseController.getWarehouseById)
warehouseRouter.get('/province/:provinceCode', [checkJwt], warehouseController.getWarehouseByProvinceCode)
